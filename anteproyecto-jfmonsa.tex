...
\usepackage{caption}
\captionsetup{skip=5pt} % controls space after caption
\addtolength{\captionmargin}{-1em} % optional: adjust as needed
...
\input{sections/0.1-resumen.tex}
...
\input{sections/2-descripcion-de-la-empresa.tex}
\input{sections/3-formulacion-del-problema.tex}
