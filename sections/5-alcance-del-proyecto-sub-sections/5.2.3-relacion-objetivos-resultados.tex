...
\newcommand\objetivoEspecificoBResultados{
  \begin{itemize}[leftmargin=*, topsep=0pt, itemsep=0pt]
    ...
    \item \textit{Backend} en Go con separación estricta \textit{Handler--Service--Repository} y repositorios definidos por interfaz, que habiliten pruebas unitarias sin acceso a la base de datos real y preserven la opción de sustituir el motor de persistencia sin tocar la lógica de negocio.
  \end{itemize}
}
...
\newcommand\objetivoEspecificoDResultados{
  \begin{itemize}[leftmargin=1em, topsep=2pt, itemsep=2pt]
    ...
    \item Pipeline de integración continua en GitHub Actions que ejecute validación diferencial sobre los archivos modificados en cada \textit{pull request}.
